<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mail.aspx.cs" Inherits="Mail.MailMail" %>
			...
			<div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li><a href="/Admin/Admin.aspx">后台入口</a></li>
                        <li><a href="/Manager/Manager.aspx">经理入口</a></li>
                        <li><a href="/Sign.aspx">考勤操作</a></li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        <li><p class="navbar-text" style="margin-left: 5px">你好，<a href="/User/Usercenter.aspx">何钰童</a></p></li>
                        <li><asp:LinkButton runat="server" OnClick="LogOut">退出登录</asp:LinkButton></li>
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel panel-default" style="padding: 4px">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li role="presentation">
                                <a href="/Mail/Mail.aspx" class="active">信箱</a>
                            </li>
                            <li role="presentation">
...
<!--右侧部分-->
                ...
                <ContentTemplate>
                    <asp:Panel class="panel panel-default" runat="server" ID="panel_Mail" style="min-height: 700px">
                        <div class="panel-heading">
                            <h3 class="panel-title">信箱</h3>
                        </div>
